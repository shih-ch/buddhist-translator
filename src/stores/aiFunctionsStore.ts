...
const DEFAULT_FUNCTIONS: AIFunctionConfig[] = [
  {
    ...
    provider: RECOMMENDED_MODELS.translation.provider,
    model: RECOMMENDED_MODELS.translation.model,
  ...
  },
  {
    ...
    provider: RECOMMENDED_MODELS.formatting.provider,
    model: RECOMMENDED_MODELS.formatting.model,
  ...
  },
  {
    ...
    provider: RECOMMENDED_MODELS.term_extraction.provider,
    model: RECOMMENDED_MODELS.term_extraction.model,
  ...
  },
  {
    ...
    provider: RECOMMENDED_MODELS.url_cleanup.provider,
    model: RECOMMENDED_MODELS.url_cleanup.model,
  ...
  },
  {
    ...
    provider: RECOMMENDED_MODELS.source_formatting.provider,
    model: RECOMMENDED_MODELS.source_formatting.model,
  ...
  },
  {
    ...
    provider: RECOMMENDED_MODELS.translation_formatting.provider,
    model: RECOMMENDED_MODELS.translation_formatting.model,
  ...
  },
  {
    ...
    provider: RECOMMENDED_MODELS.dictionary_lookup.provider,
    model: RECOMMENDED_MODELS.dictionary_lookup.model,
  ...
  },
  {
    ...
    provider: RECOMMENDED_MODELS.glossary_fill.provider,
    model: RECOMMENDED_MODELS.glossary_fill.model,
  ...
  },
  {
    ...
    provider: RECOMMENDED_MODELS.extract_mantra.provider,
    model: RECOMMENDED_MODELS.extract_mantra.model,
  ...
  },
  {
    ...
    provider: RECOMMENDED_MODELS.format_mantra.provider,
    model: RECOMMENDED_MODELS.format_mantra.model,
  ...
  },
  {
    ...
    provider: RECOMMENDED_MODELS.ocr_image.provider,
    model: RECOMMENDED_MODELS.ocr_image.model,
