...
|------|----------|------------------:|--------|
| **翻譯** | Claude Opus 5 | $5 / $25 | 長文、多語種、五欄對照的嚴格格式，錯了要手動修——唯一值得花錢的地方 |
| **格式整理** | GPT-5.6 Luna | $0.2 / $1.2 | 機械重排，整篇進整篇出 → 輸出價才是成本主體 |
| **術語提取** | GPT-5.6 Luna | $0.2 / $1.2 | 要吐合法 JSON，比純排版更吃指令遵循；輸出量小，貴一點無所謂 |
| **網頁摘取整理** | GPT-5.6 Luna | $0.2 / $1.2 | 原始 HTML 又髒又長，需要一點理解力，不用最陽春的 |
| **原文排版** | GPT-5.6 Luna | $0.2 / $1.2 | 機械重排，整篇進整篇出 → 輸出價才是成本主體 |
| **譯文排版** | GPT-5.6 Luna | $0.2 / $1.2 | 機械重排，整篇進整篇出 → 輸出價才是成本主體 |
| **佛學辭典** | Claude Opus 5 | $5 / $25 | 吃模型腦內的梵藏佛學知識，小模型會很有自信地編造詞源；用量極小 |
| **術語翻譯補齊** | GPT-5 Nano | $0.05 / $0.4 | 批次跑幾千筆、每筆只輸出兩三個字，挑最低單價 |
...
> Gemini 3.x Flash 的 $0.75/$3.75 於 2027-01-01 起回到 $1.50/$7.50。
